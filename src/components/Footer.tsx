  ...
  return (
    <footer className="bg-[#042881] text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-10 md:gap-8">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 space-y-4">
            <div className="flex items-center gap-3">
              <div className="relative w-10 h-10 md:w-12 md:h-12 rounded-xl overflow-hidden ring-2 ring-white/10">
            ...
            <div className="flex items-center gap-3 pt-1">
              <a href="https://www.facebook.com/share/18zbnkpX9y/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#1877F2] flex items-center justify-center transition-colors" aria-label="Facebook">
              ...
              <a href="https://www.tiktok.com/@illariunajma6?_r=1&_t=ZS-97gQOV9ixvB" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 hover:bg-black flex items-center justify-center transition-colors" aria-label="TikTok">
                <svg className="w-4.5 h-4.5 fill-current" viewBox="0 0 24 24" width="18" height="18">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <ul className="space-y-2.5">
              <li className="flex items-start gap-2 text-white/60 text-xs md:text-sm">
                <MapPin className="w-3.5 h-3.5 text-[#FA9A06] flex-shrink-0 mt-0.5" />
                <span>UNAJMA, Andahuaylas</span>
              </li>
              <li className="flex items-start gap-2 text-white/60 text-xs md:text-sm">
                <Mail className="w-3.5 h-3.5 text-[#FA9A06] flex-shrink-0 mt-0.5" />
